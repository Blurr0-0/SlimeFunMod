...
public class BlockPlacerMenu extends AbstractContainerMenu {
    ...
    public BlockPlacerMenu(int pContainerId, Inventory pPlayerInventory) {
        this(pContainerId, pPlayerInventory, new SimpleContainer(9));
    }

    public BlockPlacerMenu(int pContainerId, Inventory pPlayerInventory, Container pContainer) {

...
import net.blurr.slimefun.screen.slot.ModOutputSlot;
...
public class SmelteryMenu extends AbstractContainerMenu {
    private final SmelteryEntity blockEntity;
    ...
    public SmelteryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        blockEntity = ((SmelteryEntity) entity);
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new ModOutputSlot(handler,0 , 116, 35));

            this.addSlot(new SlotItemHandler(handler, 1, 20, 26));
            this.addSlot(new SlotItemHandler(handler,2 , 38, 26));
            this.addSlot(new SlotItemHandler(handler,3 , 56, 26));

            this.addSlot(new SlotItemHandler(handler,4 , 20, 44));
            this.addSlot(new SlotItemHandler(handler, 5, 38, 44));
            this.addSlot(new SlotItemHandler(handler, 6, 56, 44));
        });

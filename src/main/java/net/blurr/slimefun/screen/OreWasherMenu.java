...
public class OreWasherMenu extends AbstractContainerMenu {
    private final OreWasherEntity blockEntity;
    ...
    public OreWasherMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler,0 , 62, 17));
            ...
            this.addSlot(new SlotItemHandler(handler, 7, 80, 53));
            this.addSlot(new SlotItemHandler(handler, 8, 98, 53));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.ORE_WASHER.get());
    }
